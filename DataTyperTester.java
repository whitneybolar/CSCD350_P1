...
class DataTyperTester {
	...
	public void testAttitudeYaw() {
		...
		AttitudeYaw ay2 = new AttitudeYaw(yaw);
		AttitudeYaw ay3 = new AttitudeYaw(yaw);
		
		//• -5 + y is correct.
		AttitudeYaw ay1_result = ay1.subtract_(new AttitudeYaw(5));
		assertEquals(5.0, ay1_result.getValue_());
		
		//• 175 + y is correct.
		    ay1_result = ay2.add_(new AttitudeYaw(175.0));
				assertEquals(-175.0, ay1_result.getValue_());

			//• 5 + y is correct.
			ay1_result = ay3.add_(new AttitudeYaw(5.0));
			assertEquals(15.0, ay1_result.getValue_());
				
			// • -175 + y is correct.
			ay1_result = ay1.add_(new AttitudeYaw(-175));
		    	assertEquals((-165.0), ay1_result.getValue_());
    ...
    double c = 10.0;
		...
		assertEquals((c+355)-360, cor_result.getValue_());
		//comment the below out before turn in
		...
		assertEquals(345, cor_result.getValue_());
		//comment the below out before turn in
